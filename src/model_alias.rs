...
pub const KNOWN_MODELS: &[KnownModel] = &[
    KnownModel {
        ...
        upstream_model: "global.anthropic.claude-sonnet-4-6",
    ...
    KnownModel {
        id: "claude-haiku-4-5",
        provider: Provider::Bedrock,
        upstream_model: "global.anthropic.claude-haiku-4-5-20251001-v1:0",
    ...
    KnownModel {
        ...
        provider: Provider::Bedrock,
        upstream_model: "global.anthropic.claude-opus-4-6-v1",
        accepts_dated_snapshots: false,
    },
    KnownModel {
        id: "claude-opus-4-6",
